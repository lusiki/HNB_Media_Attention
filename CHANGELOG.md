...
Public contact links are generated only from the approved `contact` field in `content/study.json`. Private engagement notes and QA captures remain outside the publication and Git.
