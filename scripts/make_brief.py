...
def make(lang):
    ...
    y=text(choose('The paper asks whether HNB’s relative media visibility keeps pace when inflation dominates the news. Its contribution is to separate what the institution publishes from its place in the wider debate. Higher inflation accompanies a smaller institutional share in the primary models; lower inflation does not guarantee that share recovers.','Rad ispituje prati li relativna medijska vidljivost HNB-a širenje vijesti o inflaciji. Njegov je doprinos razlikovanje onoga što institucija objavljuje od njezina mjesta u široj raspravi. U primarnim modelima viša inflacija prati manji institucionalni udio; niža inflacija ne jamči njegov oporavak.'),y)-13
    ...
    y=text(choose('January 2021-May 2026: 62 eligible months / 270 weeks; 60 / 268 in the main regressions. January-March 2024 is excluded monthly. Collection changed in April 2024; levels across that date are not harmonised. Source composition can vary even within common sources. Generic central-bank terms may include the ECB or others; potential reach is not observed exposure. The selected corpus is not a representative audience sample. Earlier-paper numerical discrepancies remain unresolved.','Siječanj 2021.-svibanj 2026.: 62 uporabljiva mjeseca / 270 tjedana; 60 / 268 u glavnim regresijama. Siječanj-ožujak 2024. isključen je mjesečno. Prikupljanje se promijenilo u travnju 2024.; razine preko tog datuma nisu usklađene. Sastav objava može varirati i među zajedničkim izvorima. Generički izrazi mogu uključiti ESB ili druge banke; potencijalni doseg nije opažena izloženost. Korpus nije reprezentativan uzorak publike. Numerička odstupanja ranijeg rada ostaju neriješena.'),y,8.5,leading=11.1)-9
    ...
    y=text('<link href="https://lusiki.github.io/HNB_Media_Attention/read/paper.html" color="'+BLUE+'">'+choose('Full paper','Cjeloviti rad')+'</link> | <link href="https://lusiki.github.io/HNB_Media_Attention/'+choose('index.html','hr.html')+'" color="'+BLUE+'">'+choose('Research page and interactive evidence','Istraživačka stranica i dodatni nalazi')+'</link>',y,9)
