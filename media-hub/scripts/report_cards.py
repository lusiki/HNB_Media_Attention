...
def report_cards(artifacts,lang):
    ...
    specs=[
      ('hnb-u-medijskom-prostoru','HNB u medijskom prostoru',
       ...
       t('A timeline, subject screens and monthly portraits now include source-normalized rates, concentration, breadth, title shares and composition sensitivity.',
         'Kretanje kroz vrijeme, tematski skupovi i mjesečni portreti prošireni su stopama izvora, koncentracijom, obuhvatom, udjelima naslova i osjetljivošću na sastav.'),
      ...
      ('hnb-od-rijeci-do-javnih-pitanja','HNB: od riječi do javnih pitanja',
       ...
       t('Vocabulary, a same-body subject comparison and quarterly frequencies connect to public examples. The cash-exchange source remains unverified.',
         'Rječnik, usporedba tema na istim tekstovima i tromjesečne frekvencije povezani su s javnim primjerima. Izvornik primjera zamjene gotovine još nije potvrđen.'),
