...
Run from the publication checkout; requires ReportLab and pypdf. The site-matched
edition embeds installed Georgia and Segoe UI fonts from HNB_REPORT_FONT_DIR
(default: Windows Fonts). No database or network is used.
"""
